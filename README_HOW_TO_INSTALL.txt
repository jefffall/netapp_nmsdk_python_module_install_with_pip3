In a python program import this module as:

from netapp_nmsdk import NaElement, NaServer # for NMSDK

To install this module into your python environment:

git clone to get this file
then

pip3 install netapp-nmsdk-1.0.0.tar.gz

I take NO credit for NMSDK and it is the property of Netapp.
I just packaged it to make it easy to install via automation.

This NMSDK is circa 2011

And it can be used like this in your python
